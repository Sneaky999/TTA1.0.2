...
const MISSION_ZONES = [
  { x1:20, y1:20, x2:24, y2:24, missionId:'delivery_01', name:'PHONE BOOTH'   },
  { x1:60, y1:62, x2:64, y2:66, missionId:'hit_01',      name:'CONTACT'       },
  { x1:50, y1:10, x2:54, y2:14, missionId:'rampage_01',  name:'GANG BOSS'     },
  { x1:14, y1:48, x2:18, y2:52, missionId:'escape_01',   name:'SAFEHOUSE'     },
  { x1:85, y1:30, x2:89, y2:34, missionId:'patrol_01',   name:'COP INFORMANT' },
];
...
function _buildUI() {
  ...
  _zonePromptEl.style.cssText = `
    ...
    font-size:10px;color:rgba(255,200,0,0.85);letter-spacing:1.5px;z-index:25;
